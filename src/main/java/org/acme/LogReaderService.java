...
public class LogReaderService {
    ...
    private void saveLastReadIdToFile(Long lastReadId) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(LAST_READ_ID_FILE))) {
    ...
    // This method is triggered at application startup and scheduled every 2 minutes
